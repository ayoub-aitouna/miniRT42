...
/*   Updated: 2023/08/01 02:59:49 by aaitouna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	this->m_camera = camera(val->field_of_view / 100, 1, (double)WIDTH / (double)HEIGHT);
...
t_scene *scene(void *mlx, void *mlx_win, t_list *parsed_list)
{
	...
	ambient_prop->color = ms_num_muliplication(ambient_prop->color, ambient_prop->intensity);
