...
/*   Updated: 2023/07/08 14:22:26 by aaitouna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	cy_int_test(object_t *this, ray_t *camera_ray, propretries_t *prop)
{
	...
	cylinder_prop = ((cep_t){
		...
		.valide_intersections = (int[]){
			FALSE, FALSE, FALSE, FALSE},
		.intersections = (vector_t *[]){NULL, NULL, NULL, NULL}});
...
void	calulcat_cap_intersection(vector_t p, vector_t n, cep_t *cylinder_prop)
{
